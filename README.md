...
¡Bienvenid@ a mi portafolio personal! Aquí reuní mis proyectos, habilidades técnicas y una forma de contactarme en una sola página.

🚀 **Ver sitio en vivo:** [https://portafolio-diana-hurtado.netlify.app](https://portafolio-diana-hurtado.netlify.app)

---

## ✨ Características Principales

- **Sobre Mí:** Breve resumen sobre mi trayectoria, enfoque y pasión por la tecnología.
- **Proyectos:** Galería de proyectos destacados con accesos directos a código y demostraciones.
- **Tecnologías:** Muestra visual del stack de herramientas y lenguajes que manejo.
...
```text
├── assets/          # Imágenes, íconos y archivos (CV, gráficos)
├── css/             # Archivos de estilos personalizados
├── js/              # Scripts de JavaScript (interactividad y EmailJS)
